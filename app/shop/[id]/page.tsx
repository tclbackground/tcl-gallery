...
const productsDatabase = [
  {
    ...
    description:
      "Elephant Procession - Kalamkari Art reflects the hand-painted beauty of Kalamkari art, offering timeless floral and folk elegance as part of your wall art decor.",
  },
];
...
const accordionSections = [
  {
    ...
    icon: FiFileText,
    content:
      "Handcrafted using 100% natural dyes on organic cotton canvas. Features high-definition Giclée printing with museum-grade archival pigments engineered for 100+ years of color stability.",
  },
  {
    id: "customisations",
    ...
    icon: FiSliders,
    content:
      "We offer custom dimensions, personalized matboard border widths, floating frame mounts, and specialized UV-blocking museum acrylic glazing.",
  },
  {
    id: "returns",
    ...
    icon: FiRefreshCw,
    content:
      "Hassle-free 7-day exchange and return policy for damaged or transit-impacted items. Free insured gallery pickup across India.",
  },
  {
    id: "faq",
  ...
  },
  {
    ...
    icon: FiInfo,
    content:
      "Includes a signed Certificate of Authenticity with a unique serial number registered under TCL Gallery Archives.",
  },
];
...
const reviewsData = [
  {
    ...
    content:
      "The colors on the canvas are rich and vibrant. The teak wood framing is museum-grade as promised. It looks absolutely regal on our living room wall.",
    verified: true,
  },
  {
    id: "r2",
    ...
    content:
      "Arrived safely packed with transit corner protectors. The 3D room viewer on the site gave an accurate preview of how it would fit our wall space.",
    verified: true,
  },
  {
    id: "r3",
    ...
    content:
      "Beautiful hand-painted Kalamkari motifs. Highly recommend opting for the Italian dark wood frame option.",
    verified: true,
  },
];
...
export default function SingleProductPage({
  ...
  const product =
    productsDatabase.find((p) => p.id === resolvedParams.id) ||
    productsDatabase[0];
  ...
  const [activeTab, setActiveTab] = useState<"canvas" | "framing" | "giclee">(
    "giclee"
  );
  ...
  const unitPrice = Math.round(
    product.basePrice * sizeObj.priceMultiplier + frameSurcharge
  );
  const calculatedPrice = unitPrice * quantity;
  const calculatedOriginalPrice = Math.round(
    (product.originalPrice * sizeObj.priceMultiplier + frameSurcharge) *
      quantity
  );
          ...
          <div className="lg:col-span-6 space-y-6">
              ...
              <div className="flex items-center gap-2 pt-1">
                <div className="flex text-[#7B8F50] text-xs">
                  {[...Array(5)].map((_, i) => (
                    <FiStar
                      key={i}
                      className="fill-[#7B8F50] text-[#7B8F50]"
                    />
                  ))}
                </div>
                <span className="text-xs text-[#66635B] font-medium">
                  477 reviews
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="inline-flex items-center border border-[#E0D8C8] rounded-full bg-white">
                ...
                <span className="px-4 text-xs font-bold text-[#22211B]">
                  {quantity}
                </span>
                <button
            ...
            <div className="space-y-2.5 pt-1">
              <button
                ...
                className="w-full py-4 px-6 border-2 border-[#7B8F50] text-[#7B8F50] text-xs font-bold uppercase tracking-wider rounded-full hover:bg-[#7B8F50] hover:text-white transition shadow-sm cursor-pointer"
              >
                Add to cart
              </button>
              <button
                onClick={handleAddToCart}
                className="w-full py-4 px-6 bg-[#22211B] text-white text-xs font-bold uppercase tracking-wider rounded-full hover:bg-[#7B8F50] transition shadow-md cursor-pointer"
              >
                Buy it now
              </button>
            </div>
            ...
            <div className="pt-6 border-t border-[#EAE3D2]">
              <div className="flex items-center justify-between max-w-md mx-auto text-center relative">
                ...
                <div className="flex flex-col items-center gap-1 z-10 bg-[#FDFBF7] px-2">
                  ...
                  <span className="text-xs font-bold text-[#22211B] mt-1">
                    Aug 11th
                  </span>
              ...
              return (
                <div key={sec.id} className="border-b border-[#EAE3D2] py-3">
                  ...
                  >
                    ...
                    {isOpen ? (
                      <FiChevronUp className="text-[#7B8F50] text-base" />
                    ) : (
                      <FiChevronDown className="text-[#88847C] text-base" />
                    )}
                  </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="p-5 rounded-2xl border border-[#EAE3D2] bg-white shadow-xs space-y-1 hover:border-[#7B8F50] transition">
                  ...
                  <p className="text-[11px] text-[#55534E] font-light pl-6">
                    State of the art pigment delivery system designed by Seiko
                    Japan
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-4 flex flex-col justify-between">
                  ...
                  <div className="relative aspect-[4/3] w-full rounded-2xl overflow-hidden border border-[#EAE3D2] bg-white shadow-xs">
                    <Image
                      src="https://images.unsplash.com/photo-1513519245088-0e12902e5a38?w=800&auto=format&fit=crop"
                      alt="Printer Setup"
                      fill
                      unoptimized
                      className="object-cover"
        ...
        <div className="pt-8 border-t border-[#EAE3D2] space-y-20">
          ...
          <div className="space-y-10">
            <div className="border-b border-[#EAE3D2] pb-6 flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <div className="font-serif text-3xl font-bold text-[#22211B]">
                    4.9
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-4 bg-[#FAF8F5] p-6 rounded-2xl border border-[#EAE3D2] space-y-3">
                <h3 className="font-serif text-base font-bold text-[#22211B] mb-4">
                  Rating Breakdown
                </h3>
                {[
                  ...
                  <div
                    key={item.stars}
                    className="flex items-center gap-3 text-xs text-[#55534E]"
                  >
              ...
              <div className="lg:col-span-8 space-y-6">
                {reviewsData.map((rev) => (
                  <div
                    key={rev.id}
                    className="p-6 rounded-2xl border border-[#EAE3D2] bg-white space-y-3 shadow-xs"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-bold text-[#22211B]">
                          {rev.author}
                        </span>
                        {rev.verified && (
                      ...
                      <span className="text-xs text-[#88847C]">
                        {rev.date}
                      </span>
                    </div>
                    ...
                    <p className="text-xs text-[#55534E] leading-relaxed font-light">
                      {rev.content}
                    </p>
          ...
          <div className="space-y-8 pt-8 border-t border-[#EAE3D2]">
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/shop"
                className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#7B8F50] hover:underline"
              >
      ...
      {showSliderModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#FDFBF7] rounded-3xl max-w-4xl w-full p-6 sm:p-8 space-y-4 relative border border-[#EAE3D2]">
            ...
            <div className="relative h-[450px] w-full overflow-hidden rounded-2xl border border-[#EAE3D2] bg-[#FAF8F5] select-none">
              {/* BASE LAYER: Room Scene with Framed Artwork */}
              ...
              {/* OVERLAY LAYER: Clipped Raw Artwork */}
              <div
