// app/collections/travel-places/page.tsx
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b border-[#C4A892]/30 pb-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Journey through vibrant cityscapes, remote destinations, and iconic landmarks captured in archival-grade fine-art photography.
          </p>
        </header>
