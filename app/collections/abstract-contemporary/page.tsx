// app/collections/abstract-contemporary/page.tsx

export const dynamic = "force-dynamic";

export default function AbstractContemporaryPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b border-[#C4A892]/30 pb-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Discover curated contemporary expressions, textured abstract canvases, and modern minimalist works.
          </p>
        </header>
