// app/collections/architecture-interiors/page.tsx

export const dynamic = "force-dynamic";

export default function ArchitectureInteriorsPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b border-[#C4A892]/30 pb-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Explore curated fine art prints capturing architectural forms, structural elegance, and interior spaces.
          </p>
        </header>
