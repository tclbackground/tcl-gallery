// app/collections/nature-landscapes/page.tsx

export const dynamic = "force-dynamic";

export default function NatureLandscapesPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 border-b border-[#C4A892]/30 pb-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Immerse in breathtaking vistas, tranquil wilderness, and natural landscapes captured on museum-grade archival paper and canvas.
          </p>
        </header>
