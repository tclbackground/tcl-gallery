...
export default function EditProductForm({
  ...
  const imageLabels = [
    {
      title: "Main Image",
      description:
        "Primary product/card image",
    },
    {
      title: "Image 2",
      description:
        "Alternate artwork view",
    },
    {
      title: "Image 3",
      description:
        "Framed/interior view",
    },
    {
      title: "Image 4",
      description:
  ...
  const handleFileChange = (
    ...
    if (!file.type.startsWith("image/")) {
      ...
      setMessage({
        text:
          `${imageLabels[index].title} must be an image.`,
        type: "error",
      });
    ...
    if (
      ...
      setMessage({
        text:
          `${imageLabels[index].title} must be smaller than 10 MB.`,
        type: "error",
      });
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setMessage({
        text:
          "Artwork and all 5 images updated successfully!",
        type: "success",
      });
      ...
      ">
        ...
        <div>
          ...
          >
            ...
            <option value="design-store">
              DESIGN STORE
            </option>

            <option value="korea-products">
              KOREA PRODUCTS
            </option>
