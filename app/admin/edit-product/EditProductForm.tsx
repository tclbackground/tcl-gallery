...
// Built-in inline SVG placeholder (prevents missing image 404s)
const FALLBACK_SVG =
...
export default function EditProductForm({
  ...
  // Instant preview when typing a URL or public path
  ...
  // Instant preview when selecting a local image file
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res && res.success === false) {
        ...
        setMessage({
          text: "✅ Artwork and image updated successfully!",
          type: "success",
        });
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-3 border rounded-xl bg-white text-sm outline-none focus:border-[#7B8F50]"
          >
      ...
      {/* Live Artwork Image Preview Box */}
      <div>
        <label className="block text-xs font-bold uppercase mb-2">
